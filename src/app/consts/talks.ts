export const talks = {
  ...
  "19_ng_conf_2019": {
    ...
    talk: {
      ...
      description:
        "What’s it like for a woman in tech? This presentation will be a collection of horror stories from a woman technologist’s day to day. Some stories are funny. Others are horrifying. Some are sad, cringe-worthy or will make you cry. Why are some common behaviors considered inappropriate? It’s just a compliment after all, why do you fret so much? After some bad experiences, some years of therapy, and some talks with friends and co-workers, I will talk about why “just a compliment” is not appropriate in all settings. And how that compliment can result in an objectification of the person receiving it, instead of serving a spirit-lifting message.",
      duration: "20 mins",
      media: {
        slides: "",
        code: [],
