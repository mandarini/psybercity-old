export const talks = {
  "01_angular_connect_2017": {
    ...
    day: 7,
    conf_info: {
      website: "https://www.angularconnect.com/",
      location: "London, UK",
  ...
  "04_WeAreDevelopers_2018": {
    ...
    day: 18,
    conf_info: {
      website: "https://events.wearedevelopers.com/",
  ...
  "11_developers_day_2019": {
    ...
    talk: {
      ...
      description: "Talking about why one should use Angular.",
      duration: "15 mins",
      media: {
        slides: "http://bit.ly/2YXDOKs",
        code: [],
        demo: [],
        photos: [],
  ...
  "14_angularathens_5th": {
    ...
    date: "1551175200000",
    code: "angularathens",
    name: "Angular Athens 5th Meetup",
    year: 2019,
    month: 1,
    day: 26,
    conf_info: {
      website: "https://www.meetup.com/Angular-Athens/",
      location: "Athens, Greece",
  ...
  "16_devStaff_Heraklion_1": {
    ...
    workshop: {
      ...
      media: {
        slides: "https://psybercity.page.link/devstaff",
        docs: "https://github.com/mandarini/chat-workshop-docs",
  ...
  "17_wtm_greece_2019": {
    ...
    day: 30,
    conf_info: {
      website: "https://womentechmakers.gr/iwd19/",
      location: "Athens, Greece",
  ...
  "18_real_talk_js_26": {
    ...
    day: 2,
    conf_info: {
      website: "https://realtalkjavascript.simplecast.fm/",
      location: "online",
      coords: [],
      venue: "online",
      date: "April 2, 2019"
  ...
  "19_ng_conf_2019": {
    ...
    workshop: {
      title:
        "Sani Yusuf's Reactive Forms DEmistified - delivered together with Sani Yusuf",
      description:
  ...
  "20_larissa_dev_2019": {
    ...
    date: "1558717200000",
    code: "larissa_dev",
    name: "Larissa Developers Meetup",
    year: 2019,
    month: 4,
    day: 24,
    conf_info: {
      website:
        "https://www.meetup.com/Larissa-Developers-Meetup/events/261475460/",
    ...
    talk: {
      ...
      description:
        "Use Angular and Firebase as a complete solution to build your web applications. From bootstrapping with the CLI, to database, storage, notifications and deployment with Firebase, in this presentation we will see how these two technologies combined can solve all your problems, making things simpler for you and your app. We'll see techniques, tips and best practices!",
      duration: "45 mins",
      media: {
        slides: "",
        code: [],
  ...
  "21_angularathens_7th": {
    ...
    date: "1551175200000",
    code: "angularathens",
    name: "Angular Athens 7th Meetup",
    year: 2019,
    month: 6,
    day: 9,
    conf_info: {
    ...
    talk: {
      ...
      duration: "30 mins",
      media: {
        slides: "https://psybercity.page.link/cloud",
  ...
  "22_angularonline": {
    ...
    date: "1564689600000",
    code: "modernweb",
    name: "Modern Web - Angular Online",
    year: 2019,
    month: 7,
    day: 1,
    conf_info: {
  ...
  "23_ngde": {
    ...
    talk: {
      ...
      description:
        "Creating A More Sustainable Development Team with Angular and the PAMstack - with Tracy Lee",
      duration: "30 mins",
      media: {
        slides: "",
        code: [],
  ...
  "25_ngSpain": {
    ...
    talk: {
      ...
      duration: "30 mins",
      media: {
        slides: "https://psybercity.page.link/ng-spain",
